...
search_gui = SearchGUI(window, style, ui_font, tk_title, root)  # Instantiate SearchGUI
title_bar = CustomTitleBar(root, tk_title, window, style, search_gui.frame, ui_font) #handles the custom title bar
